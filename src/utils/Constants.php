...
namespace Nikolag\Myservice\Utils;
...
{
	//Transaction info
    const TRANSACTION_NAMESPACE     = 'Nikolag\Myservice\Models\Transaction';
    ...
    //Customer info
    const CUSTOMER_NAMESPACE        = 'Nikolag\Myservice\Models\Customer';
